...
def run():
    ...
    util.dump_pickle("./test_data/PU/test_pickle/target_data.pickle", target_data)
    ...
    target_data = util.load_pickle("./test_data/PU/test_pickle/target_data.pickle")
    test_data = util.load_pickle("./test_data/PU/data/avro_50_pu_link.pickle")
